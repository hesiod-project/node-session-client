          ...
          */
          ...
          if (serverMsg.data) {
            ...
            try {
              ...
              if (!verified) {
                console.warn('SessionOpenGroupV3Server::getMessages - Could not verify signature on')
              }
            } catch (e) {
              console.warn('SessionOpenGroupV3Server::getMessages - Could not verify signature on', e)
            }
